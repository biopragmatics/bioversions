...
- **ITIS**
  `[itis] failed to resolve: HTTPSConnectionPool(host='www.itis.gov', port=443): Read timed out. (read timeout=3)`
...
urllib3.exceptions.ReadTimeoutError: HTTPSConnectionPool(host='www.itis.gov', port=443): Read timed out. (read timeout=3)
...
Traceback (most recent call last):
  ...
  File "/home/runner/work/bioversions/bioversions/src/bioversions/utils.py", line 87, in _cache_prop
    cls._cache = cls().get()
                 ^^^^^^^^^^^
  File "/home/runner/work/bioversions/bioversions/src/bioversions/sources/itis.py", line 25, in get
...
requests.exceptions.ReadTimeout: HTTPSConnectionPool(host='www.itis.gov', port=443): Read timed out. (read timeout=3)

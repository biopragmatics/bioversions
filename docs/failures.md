...
- **Online Mendelian Inheritance in Man**
  `[Online Mendelian Inheritance in Man] issue parsing: time data 'Augu 6, 2025' does not match format '%B %d, %Y'`
- **Zebrafish Information Network**
  `[zfin] failed to resolve: HTTPSConnectionPool(host='zfin.org', port=443): Read timed out. (read timeout=15)`
...
ValueError: time data 'Augu 6, 2025' does not match format '%B %d, %Y'
